...
RUN apt-get update
RUN apt-get install -y subversion screen rsync sudo libxml-parser-perl libarchive-extract-perl libarchive-zip-perl libpath-class-perl wget curl unzip lib32gcc1
